...
####The password length should be longer than the(alphabets,digits,special characters)
...
#So, what is the difference between the previous code and this code?(password4.py/password5.py)
